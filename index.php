...
if ((!isset($_SESSION['cpf']) == true) and (!isset($_SESSION['senha']) == true)) {
 ...
 echo "<script>alert('voce tem que fazer login')</script>";
} else {
    $cpf= $_SESSION['cpf'];
...
<body>
    ...
    <div class=" flex items-center justify-between mx-auto ">
      ...
      <div class="items-center m-auto flex justify-between w-full md:flex md:w-auto" id="navbar-sticky">
        <ul class="flex p-4 md:p-0 mt-4 m-auto align-center font-medium md:text-center rounded-lg bg-white md:mt-0 md:border-0 md:bg-white  max-md:text-xs max-md:p-2">
          ...
          <li>
            <a href="./favoritos.php" class=" py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100">Favoritos</a>
          </li>
          <li>
            <a class="cursor-pointer py-2 pl-3 pr-4 text-gray-900  rounded hover:bg-gray-100" data-modal-toggle="login-modal">Login</a>
          </li>
    ...
    <div id="cadastrar-modal" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
      <div class="relative w-full max-w-md px-4 h-full md:h-auto">
        ...
        <div class="bg-white rounded-lg shadow relative dark:bg-white">
          ...
          <form method="POST"class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="./Controllers/cadastro-controller.php">
            <h3 class="text-xl font-medium text-black dark:text-black">Cadastrar</h3>
            <div>
              <input type="text" name="nome" id="usuario" class="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-sm block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-whitedark:text-white" placeholder="Usuario" required="">
            </div>
            <div>
  ...
  <div class="max-w-2xl mx-auto">
    ...
    <!-- Main modal -->
    <div id="login-modal" aria-hidden="true" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
      <div class="relative w-full max-w-md px-4 h-full md:h-auto">
        <!-- Modal content -->
        <div class="bg-white rounded-lg shadow relative dark:bg-white">
          <div class="flex justify-end p-2">
            <button type="button" class="text-gray-400 bg-transparent hover:bg-white hover:text-zinc-800 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="login-modal">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
              </svg>
            </button>
          </div>
          <form method="POST" class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" action="./Controllers/login.php">
            <h3 class="text-xl font-medium text-black dark:text-black">Login</h3>
            <div>
            <input type="text" name="cpf" id="email" class="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-sm block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-whitedark:text-white" placeholder="CPF" required="">
            </div>
            <div>
            <input type="password" name="senha" id="password" placeholder="Senha" class="bg-white border border-gray-300 text-gray-900 sm:text-sm rounded-sm block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-whitedark:text-white" required="">
            </div>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="grid px-55 lg:grid-cols-2 gap-6 justify-center align-center m-auto">
    ...
    <div class="grid mt-10 grid-cols-4 gap-4">
      ...
      <div>
        <img class=" " src="./produtos/Camisa Ryan.jpg" alt="">
        <p class="text-center">Camisa Ryan</p>
        <div class="flex align-center justify-center m-auto mt-5">
							<!-- LIKE -->
							<svg
								width="24"
      ...
      <!-- GRIDS DA PARTE INFERIOR-->


      <div>
        <img class="" src="./produtos/Camisa Jude.jpg" alt="">
        <p class="text-center">Camisa Jude</p>
        <div class="flex align-center justify-center m-auto mt-5">
							<!-- LIKE -->
							<svg
								width="24"
      ...
      <div>
        ...
        <p class="text-center">Camisa Kurt</p>
        <div class="flex align-center justify-center m-auto mt-5">
							<!-- LIKE -->
							<svg
								width="24"
    ...
    <!-- FIM DOS GRID INFERIORES -->
    <div class="grid mt-20 grid-cols-3 gap-4">
    ...
    <div>
      ...
      <p class="text-center">Calça Bob</p>
      <div class="flex align-center justify-center m-auto mt-5">
         <!-- LIKE -->
         <svg
            width="24"
  ...
  <div>
    <img class="  " src="./produtos/Jaqueta Barry.jpg" alt="">
    <p class="text-center">jaqueta Barry</p>
    <div class="flex align-center justify-center m-auto mt-5">
      <!-- LIKE -->
      <svg
         width="24"
